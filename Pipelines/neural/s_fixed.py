# ===============================
# PIPELINE S: LaBSE + BiLSTM + LOGISTIC REGRESSION (FIXED)
# ===============================
...
# ===============================
# LOAD LABSE SEQUENCE EMBEDDINGS (No Global Normalization)
# ===============================
...
# Removed 'penalty' to avoid deprecation warnings; liblinear uses l2 by default
param_grid = {
    'C': [0.01, 0.1, 1, 10],
    'solver': ['liblinear']
}
