# ===============================
# PIPELINE S: LaBSE + BiLSTM + LOGISTIC REGRESSION (NO LEAKAGE)
# ===============================
...
# ===============================
# LOAD LABSE SEQUENCE EMBEDDINGS
# ===============================
X_seq = np.load("../labse_seq_lstm_embeddings.npy")
...
for fold, (train_idx, test_idx) in enumerate(outer_cv.split(X_seq, y)):
    ...
    for epoch in range(num_epochs):
        ...
        loop = tqdm(
            ...
            desc=f"Fold {fold+1} | Epoch {epoch+1}/10",
            leave=False
        )
